...
def merge_agm():
    ...
    # 读入数据文件
    aq_data = pd.read_csv("./data/origion_data/air_2018_3_31.csv")
    meo_data = pd.read_csv("./data/process_data/merge_grid_meo.csv")
    ...
    print("==================合并天气========开始=======")
    meo_weather_data = pd.read_csv("./data/process_data/merge_aq_meo.csv")
    ...
    df_merge.to_csv('./data/process_data/final_merge_aq_grid_meo2.csv',index=False)
