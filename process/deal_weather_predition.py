...
def deal_weather_pred():
    ######################  1.加载天气预报并排序  ###################
    beijing_weather=pd.read_csv('./data/origion_data/weather_pred_data/Beijing_weather.csv',parse_dates=['datetime'])
    ...
    beijing_weather.to_csv('./data/process_data/weather_prediction.csv', index=False)
